...
namespace CParts.Infrastructure.Business
{
    public class PartApplicabilityService : IPartApplicabilityService
    {
            ...
            int manufacturerId, int langId = 4)
        {
            ...
            await _countryDesignationsRepository.AppendDesignationsToCollection(models, langId);
            return models;
        }
        ...
        public async Task<ICollection<Type>> GetApplicableTypesByModel(int articleId, int modelId, int langId = 4)
        {
            ...
            await _countryDesignationsRepository.AppendDesignationsToCollection(types, langId);
            return types;
        }
    }
}